...
class Subscription {
  constructor(subscription) {
    (this.endpoint = subscription.endpoint), (this.keys = subscription.keys);
  }
  ...
  static subscribe(pushSubscriptionObject) {
    ...
    const SFMC_AUTH_URL =
      "https://mcjnmn9mfnxq4m36wvmtt59plqg1.auth.marketingcloudapis.com/v2/token";
    const BASE_URI =
      "https://mcjnmn9mfnxq4m36wvmtt59plqg1.auth.marketingcloudapis.com/";
    const SFMC_DATA_EXTENSION_EXTERNAL_KEY =
      "C2CF564D-3A82-4013-9AE4-6B093933B185";
    const options = {
      auth: {
        clientId: CLIENT_ID,
